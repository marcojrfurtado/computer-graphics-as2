...
void keyInput(unsigned char key, int x, int y)
{
	...
	case 'a':
		...
		centerXP = sin(angleLY) + eyeXP;
		centerZP = -cos(angleLY) + eyeZP;
		centerXO = sin(angleLY) + eyeXO;
		centerZO = -cos(angleLY) + eyeZO;
		break;
	case 'A':
		angleLY += -0.174532925;
		centerXP = sin(angleLY) + eyeXP;
	...
	case 't':
		angleLX += 0.174532925;
		centerYP = -sin(angleLX) + eyeYP;
		centerZP = -cos(angleLX) + eyeZP;
		centerYO = -sin(angleLX) + eyeYO;
		centerZO = -cos(angleLX) + eyeZO;
		upZP = -sin(angleLX);
		upYP = cos(angleLX);
		upZO = -sin(angleLX);
		upYO = cos(angleLX);
